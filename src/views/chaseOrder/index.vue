  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','chaseOrder:edit','chaseOrder:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudChaseOrder from '@/api/chaseOrder'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '追号', url: 'api/chaseOrder', sort: 'id,desc', crudMethod: { ...crudChaseOrder }})
...
export default {
  ...
  data() {
    return {
      permission: {
        add: ['admin', 'chaseOrder:add'],
        edit: ['admin', 'chaseOrder:edit'],
        del: ['admin', 'chaseOrder:del']
      },
      rules: {
        orderId: [
